...
import com.route.news.data.repositories.news_repository.NewsRepository
    ...
    fun getArticles(source: String) {
        viewModelScope.launch {
            try {
                ...
                articlesErrorMessage.value = t.message ?: "Something Went Wrong Please Try Again Later"
            }
        }
    }
}